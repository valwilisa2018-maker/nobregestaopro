...
REVOKE ALL ON FUNCTION public.get_sinal_totals(date, date) FROM PUBLIC;
REVOKE ALL ON FUNCTION public.get_sinal_totals(date, date) FROM anon;
...
CREATE OR REPLACE VIEW public.v_daily_financials
...
REVOKE ALL ON public.v_daily_financials FROM PUBLIC;
REVOKE ALL ON public.v_daily_financials FROM anon;
