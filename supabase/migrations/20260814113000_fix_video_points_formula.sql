-- Align delivered video scoring with the official rule:
-- points = total duration in seconds / 30.
-- This migration only updates the trigger for future deliveries/re-deliveries.
