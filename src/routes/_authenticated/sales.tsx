            ...
            <DialogContent className="w-[calc(100%-1rem)] sm:w-full max-w-[95vw] sm:max-w-2xl max-h-[90vh] overflow-y-auto p-0 gap-0 border border-[#E8E8E8] dark:border-white/10 rounded-[18px] bg-white dark:bg-[#0B0B0D] shadow-[0_30px_80px_-20px_rgba(0,0,0,0.35)] [&_input]:h-10 [&_input]:rounded-lg [&_input]:border-[#ECECEC] [&_input]:bg-white [&_input]:pl-9 [&_input]:text-sm [&_input]:transition-all [&_input]:duration-200 [&_input:hover]:border-[#E30613]/60 [&_input:focus]:border-[#E30613] [&_input:focus]:ring-2 [&_input:focus]:ring-[#E30613]/15 dark:[&_input]:bg-white/[0.03] dark:[&_input]:border-white/10 dark:[&_input]:text-white [&_[data-slot=select-trigger]]:h-10 [&_[data-slot=select-trigger]]:rounded-lg [&_[data-slot=select-trigger]]:border-[#ECECEC] [&_[data-slot=select-trigger]]:bg-white [&_[data-slot=select-trigger]]:pl-9 [&_[data-slot=select-trigger]:hover]:border-[#E30613]/60 [&_[data-slot=select-trigger]:focus]:border-[#E30613] [&_[data-slot=select-trigger]:focus]:ring-2 [&_[data-slot=select-trigger]:focus]:ring-[#E30613]/15 dark:[&_[data-slot=select-trigger]]:bg-white/[0.03] dark:[&_[data-slot=select-trigger]]:border-white/10 dark:[&_[data-slot=select-trigger]]:text-white [&_textarea]:rounded-lg [&_textarea]:border-[#ECECEC] [&_textarea]:bg-white [&_textarea]:transition-all [&_textarea:focus]:border-[#E30613] [&_textarea:focus]:ring-2 [&_textarea:focus]:ring-[#E30613]/15 dark:[&_textarea]:bg-white/[0.03] dark:[&_textarea]:border-white/10 dark:[&_textarea]:text-white [&_label]:text-[12px] [&_label]:font-medium [&_label]:text-neutral-700 dark:[&_label]:text-neutral-300">
              <DialogHeader className="relative overflow-hidden bg-[#0B0B0D] px-4 sm:px-6 py-4 space-y-0 border-b border-white/5">
                <div aria-hidden className="pointer-events-none absolute inset-y-0 right-0 w-2/3">
                  ...
                  <svg className="absolute right-0 top-0 h-full w-full opacity-70" viewBox="0 0 400 200" fill="none" preserveAspectRatio="none">
                    <path d="M0 120 Q100 40 200 120 T400 100" stroke="#E30613" strokeWidth="1.2" fill="none" opacity="0.35" />
                    <path d="M0 140 Q120 60 240 140 T400 120" stroke="#E30613" strokeWidth="0.8" fill="none" opacity="0.25" />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-3 p-4 sm:p-5 bg-[#FAFAFA] dark:bg-[#0B0B0D]">
                <div className="md:col-span-2">
                  ...
                  <div className="relative mt-1.5">
                    ...
                    <Input list="customers-names" placeholder="Digite o nome do cliente" value={form.customer_name || ""} onChange={(e) => autofillFromCustomer("customer_name", e.target.value)} />
                  </div>
                ...
                <div>
                  ...
                  <div className="relative mt-1.5">
                    ...
                    <Input list="customers-companies" placeholder="Nome da empresa" value={form.company || ""} onChange={(e) => autofillFromCustomer("company", e.target.value)} />
                  </div>
                ...
                <div>
                  ...
                  <div className="mt-1.5"><SafeSelect
                    ariaLabel="Com Nota"
                ...
                <div>
                  ...
                  <div className="relative mt-1.5">
                    ...
                    <Input placeholder="00.000.000/0000-00" value={form.document || ""} onChange={(e) => set("document", e.target.value)} />
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="relative mt-1.5">
                    ...
                    <Input placeholder="exemplo@email.com" value={form.email || ""} onChange={(e) => set("email", e.target.value)} />
                  </div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="relative mt-1.5">
                    <DollarSign className="pointer-events-none absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-neutral-400" />
                    <Input type="number" step="0.01" placeholder="0,00" value={form.paid_amount || ""} onChange={(e) => set("paid_amount", e.target.value)} />
                  </div>
                </div>
                <div>
                ...
                <div data-sale-field="service_type_id">
                  ...
                  {!form.service_type_id && (
                    <p className="mt-1.5 text-[11px] text-muted-foreground">Escolha o tipo de serviço antes de confirmar.</p>
                  )}
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="relative mt-1.5">
                    ...
                    <Input type="number" min="1" value={form.service_quantity || ""} onChange={(e) => set("service_quantity", e.target.value)} />
                  </div>
                </div>
                {formNeedsVideoDuration && (
                  <div data-sale-field="video_duration_seconds" className="rounded-xl border border-amber-300/70 bg-amber-50/70 p-3 dark:bg-amber-950/20">
                  ...
                  <label className="group relative mt-1.5 flex cursor-pointer flex-col items-center justify-center gap-2 rounded-2xl border-2 border-dashed border-[#E30613]/40 bg-gradient-to-b from-[#FFF5F6] to-white p-4 text-center transition-all duration-300 hover:border-[#E30613] hover:shadow-[0_10px_40px_-10px_rgba(227,6,19,0.35)] dark:from-white/[0.03] dark:to-transparent">
                    ...
                    {receiptFile ? (
                      <div className="flex flex-col items-center gap-1">
                        <p className="text-sm font-semibold text-neutral-800 dark:text-neutral-100 flex items-center gap-2"><Check className="h-4 w-4 text-emerald-600" /> {receiptFile.name}</p>
                        <p className="text-xs text-neutral-500">{(receiptFile.size / 1024).toFixed(0)} KB</p>
                        <button type="button" className="mt-1 text-xs font-medium text-[#E30613] hover:underline" onClick={(ev) => { ev.preventDefault(); ev.stopPropagation(); setReceiptFile(null); }}>Remover arquivo</button>
                      </div>
                    ) : (
                      <>
                        <p className="text-sm font-semibold text-neutral-800 dark:text-neutral-100">Clique ou arraste seu comprovante</p>
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="relative mt-1.5">
                    ...
                    <Input placeholder="Ex: 7 dias úteis" value={form.delivery_deadline || ""} onChange={(e) => set("delivery_deadline", e.target.value)} />
                  </div>
                </div>
                <div className="md:col-span-2">
                  ...
                  <div className="relative mt-1.5 [&_textarea]:pl-10 [&_textarea]:pt-3">
                    ...
                    <Textarea placeholder="Adicione observações sobre esta venda..." value={form.notes || ""} onChange={(e) => set("notes", e.target.value)} />
                  </div>
                </div>
                <div className="md:col-span-2">
              ...
              <div className="border-t border-[#E8E8E8] dark:border-white/10 bg-white dark:bg-[#0B0B0D] px-4 sm:px-5 py-3 flex flex-col gap-2">
                ...
                <div className="flex flex-col-reverse sm:flex-row sm:items-center sm:justify-end gap-2">
                  <Button type="button" variant="outline" onClick={() => setOpen(false)} className="w-full sm:w-auto h-10 rounded-lg px-4 border-[#E8E8E8] text-neutral-800 hover:bg-neutral-100 dark:border-white/10 dark:text-neutral-200 dark:hover:bg-white/[0.05]">Cancelar</Button>
                  <Button onClick={submit} disabled={saving} className="w-full sm:w-auto h-10 rounded-lg px-5 font-semibold text-white bg-gradient-to-r from-[#E30613] to-[#B00510] shadow-[0_10px_30px_-8px_rgba(227,6,19,0.6)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_16px_40px_-8px_rgba(227,6,19,0.7)] disabled:opacity-70">
