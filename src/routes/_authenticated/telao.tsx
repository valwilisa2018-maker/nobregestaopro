  ...
  return (
    ...
    >
      ...
      <style>{`
        ...
        .telao-marquee { display: inline-flex; width: max-content; animation: telao-scroll-x 40s linear infinite reverse; will-change: transform; backface-visibility: hidden; }
