...
function ContactsPage() {
  ...
  const openNew = () => {
    setEditing({ id: null, name: "", phone: "", status: "active", notes: "" });
    setOpen(true);
  };
  ...
  const onImportFile = async (f: File) => {
    ...
    try {
      ...
      if (rows.length === 0) {
        toast.error("Nenhum contato válido no arquivo");
        return;
      }
    ...
    switch (status) {
      case "active":
        return {
          ...
          className: "bg-gradient-to-r from-blue-500 to-indigo-600 text-white border-0 shadow-none",
          label: "Ativo",
        };
      case "blocked":
        return {
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {total} contato(s) salvos · gerencie seus leads e clientes.
                </p>
              </div>
            </div>
            <Button
          ...
          <div className="relative grid grid-cols-2 gap-3 md:grid-cols-4">
            {[
              ...
              },
              {
                ...
                tone: "from-red-500/25 to-rose-500/10",
              ...
              >
                <div
                  className={`flex items-center gap-2 text-xs uppercase tracking-wider ${k.text}`}
                >
                  {k.icon}
                  <span>{k.label}</span>
                </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="ml-auto flex items-center gap-2">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="outline"
                  disabled={importing}
                  className="h-11 border-white/10 bg-slate-950/50 hover:bg-slate-800/60 hover:text-foreground"
                >
                  {importing ? (
              ...
              <DropdownMenuContent
                align="end"
                className="w-64 border-white/10 bg-slate-900/95 backdrop-blur"
              >
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent
                align="end"
                className="border-white/10 bg-slate-900/95 backdrop-blur"
              >
            ...
            <Button
              onClick={openNew}
              className="h-11 bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-[0_10px_30px_-10px_rgba(59,130,246,0.6)] hover:opacity-90"
            >
              <UserPlus className="mr-2 h-4 w-4" /> Novo contato
            </Button>
          </div>
      ...
      <Card className="flex-1 flex flex-col min-h-0 overflow-hidden border border-white/10 bg-slate-900/60 backdrop-blur p-0">
        {query.isLoading ? (
          ...
          <div className="relative overflow-hidden py-16 text-center space-y-4">
            ...
            <p className="relative text-sm text-muted-foreground max-w-md mx-auto">
              Nenhum contato encontrado. Novos números que entrarem no WhatsApp aparecem aqui
              automaticamente.
            </p>
            <Button
              variant="outline"
              onClick={openNew}
              className="relative border-white/10 bg-slate-950/50 hover:bg-slate-800/60"
            >
                    ...
                    >
                      ...
                      <td className="px-4 py-3.5">
                        <Badge
                          ...
                          className={`${badge.className} text-[11px] font-medium`}
                        >
                          {badge.label}
                        </Badge>
                      </td>
      ...
      {totalPages > 1 && (
        <div className="shrink-0 flex items-center justify-end gap-2 text-sm">
          <Button
            ...
            className="border-white/10 bg-slate-950/50 hover:bg-slate-800/60"
          >
            Anterior
          </Button>
          ...
          <div className="relative overflow-hidden">
            ...
            <div className="relative space-y-4 p-6">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(v) => setEditing((s) => ({ ...s, status: v as never }))}
                >
                  <SelectTrigger className="h-11 bg-slate-900/60 border-white/10 focus:ring-blue-500/20">
                    <SelectValue />
                  </SelectTrigger>
            ...
            <DialogFooter className="relative border-t border-white/10 p-6 gap-2">
              ...
              <Button
                ...
                disabled={!editing.phone || saveM.isPending}
                className="bg-gradient-to-br from-blue-500 to-indigo-600 text-white shadow-[0_10px_30px_-10px_rgba(59,130,246,0.6)] hover:opacity-90"
              >
                {saveM.isPending ? (
                  <Loader2 className="h-4 w-4 animate-spin mr-2" />
