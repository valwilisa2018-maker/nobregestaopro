      ...
      >
        ...
        <div className="relative grid grid-cols-[minmax(0,1fr)_auto] items-center gap-4 sm:flex sm:flex-wrap sm:justify-between">
          ...
          <div className="flex shrink-0 items-center gap-2">
            ...
            <Button
              variant="premium"
              onClick={() => setEditingColumn({ name: "", color: "#64748b" })}
              className="gap-2"
            >
          ...
          return (
            <div
              ...
              onDrop={(e) => {
                ...
                const movingIds =
                  draggingGroup && draggingGroup.length
                    ? draggingGroup
                    : dragging
                      ? [dragging]
                      : [];
              ...
              <div className="flex items-center justify-between px-4 py-3 rounded-t-md bg-foreground text-background -m-3 mb-3">
                <div className="flex items-center gap-2 overflow-hidden mr-1">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      setEditingColumn({ id: col.id, name: col.name, color: col.color })
                    }
                  >
                    ...
                    return (
                      ...
                      >
                        {(first.sales?.payment_status === "pago_parcial" ||
                          (first as any).video_duration_seconds ||
                          ...
                          <div className="flex justify-end gap-1 flex-wrap">
                            ...
                            {first.sales?.payment_status === "pago_parcial" && (
                              ...
                              >
                                A receber:{" "}
                                {formatCurrency(
                                  Number(first.sales.total_amount ?? 0) -
                                    Number(first.sales.paid_amount ?? 0),
                                )}
                              </span>
                            )}
                          </div>
                        ...
                        <Card
                          draggable
                          onDragStart={() => {
                            setDraggingGroup(it.cards.map((x: any) => x.id));
                        ...
                        >
                          <CardContent className="p-3 space-y-1">
                            <div className="flex items-center justify-between">
                              ...
                              <div className="flex items-center gap-1">
                                ...
                                <Badge variant="secondary" className="text-[10px]">
                                  {it.cards.length} serviços
                                </Badge>
                              </div>
                            </div>
                            {company && (
                              <div className="text-xs text-muted-foreground pl-6">{company}</div>
                            )}
                            ...
                            <CardLinkButtons
                              driveLink={
                                first.google_drive_link ?? first.sales?.google_drive_link ?? null
                              }
                              platformLink={
                                first.platform_link ?? first.sales?.platform_link ?? null
                              }
                            />
                          </CardContent>
                        </Card>
                        {isOpen &&
                          it.cards.map((c: any) => {
                            ...
                            const waUrl = waHref(
                              phone,
                              `Olá ${c.sales?.customers?.name ?? ""}!`.trim(),
                            );
                            return (
                                      ...
                                      <TooltipTrigger asChild>
                                        <a
                                          ...
                                          onContextMenu={(e) => {
                                            ...
                                            e.stopPropagation();
                                            navigator.clipboard
                                              .writeText(formatPhoneBR(phone))
                                              .then(
                                                () =>
                                                  toast.success(
                                                    `Número copiado: ${formatPhoneBR(phone)}`,
                                                  ),
                                ...
                                >
                                  <CardContent className="p-3 space-y-2">
                                    ...
                                    <CardLinkButtons
                                      ...
                                      platformLink={
                                        c.platform_link ?? c.sales?.platform_link ?? null
                                      }
                                    />
                                  </CardContent>
                                </Card>
                  ...
                  return (
                    ...
                    >
                      {(c.sales?.payment_status === "pago_parcial" ||
                        (c as any).video_duration_seconds ||
                        ...
                        <div className="flex justify-end gap-1 flex-wrap">
                          ...
                          {c.sales?.payment_status === "pago_parcial" && (
                            ...
                            >
                              A receber:{" "}
                              {formatCurrency(
                                Number(c.sales.total_amount ?? 0) -
                                  Number(c.sales.paid_amount ?? 0),
                              )}
                            </span>
                          )}
                        </div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(v) => setEditing({ ...editing, column_id: v })}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(v) => setEditing({ ...editing, color: v === "_none" ? "" : v })}
                  >
                    <SelectTrigger>
                      <div className="flex items-center gap-2">
                        {editing.color && (
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setEditing({ ...editing, due_time: e.target.value })}
                  />
                </div>
                <div className="col-span-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setEditing({ ...editing, expected_delivery_date: e.target.value })
                    }
                  />
                </div>
              </div>
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setEditing({ ...editing, producer_id: v === "_none" ? null : v })
                  }
