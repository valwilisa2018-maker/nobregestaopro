              ...
              <li key={h.id} className="text-xs border-l-2 border-primary/40 pl-2">
                <div className="font-medium">
                  {h.from_column_name ? (
                    ...
                    <span>Criado em <b>{h.to_column_name ?? "—"}</b></span>
                  )}
                </div>
                <div className="text-[10px] text-muted-foreground">
                  {dateStr}{h.moved_by_email ? ` • ${h.moved_by_email}` : ""}
                </div>
              </li>
            );
          })}
      ...
      >
        ...
        <div className="relative grid grid-cols-[minmax(0,1fr)_auto] items-center gap-4 sm:flex sm:flex-wrap sm:justify-between">
          ...
          <div className="flex shrink-0 items-center gap-2">
            ...
            <Button variant="premium" onClick={() => setEditingColumn({ name: "", color: "#64748b" })} className="gap-2">
