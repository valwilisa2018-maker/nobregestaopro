              ...
              <div className="relative flex flex-col md:flex-row md:items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 flex-wrap">
                    <h3 className="text-base font-semibold">Sequências de Mensagens</h3>
                  ...
                  <p className="text-sm text-muted-foreground max-w-2xl mt-1">
                    Precisa enviar fluxos ao longo de dias, semanas ou meses respeitando horário, dia da semana e palavras-chave? Use o novo módulo Sequências — cada contato tem sua própria jornada individual.
                  </p>
                </div>
                <Link to="/sequences">
                  <Button size="sm"><ArrowRight className="h-4 w-4" /> Abrir Sequências</Button>
                </Link>
              </div>
            </div>
          </div>
