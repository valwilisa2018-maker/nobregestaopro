                    ...
                    >
                      ...
                      <td className="p-3">
                        {(() => {
                          ...
                          return (
                            <Badge className={isGreen ? "bg-emerald-500 hover:bg-emerald-500 text-foreground border-transparent" : ""} variant={isGreen ? "default" : s === "pending" ? "secondary" : "outline"}>
                              {label}
                            </Badge>
                          );
                        })()}
              ...
              {detail?.order && (() => {
                ...
                return (
                  <div className="text-sm space-y-2">
                    ...
                    <Row k="Status" v={<Badge className={o.status === "paid" ? "bg-emerald-500 hover:bg-emerald-500 text-foreground border-transparent" : ""} variant={o.status === "paid" ? "default" : o.status === "pending" ? "secondary" : "outline"}>{o.status === "paid" ? "Pago" : o.status === "pending" ? "Pendente" : o.status === "canceled" || o.status === "cancelled" ? "Cancelado" : o.status}</Badge>} />
              ...
              {detail?.req && (() => {
                ...
                return (
                  <div className="text-sm space-y-2">
                    ...
                    <Row k="Status" v={<Badge className={r.status === "approved" ? "bg-emerald-500 hover:bg-emerald-500 text-foreground border-transparent" : ""} variant={r.status === "approved" ? "default" : r.status === "pending" ? "secondary" : "outline"}>{r.status === "approved" ? "Aprovado" : r.status === "pending" ? "Pendente" : r.status === "rejected" ? "Rejeitado" : r.status}</Badge>} />
