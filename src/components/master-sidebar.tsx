...
const groups = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Pedidos", url: "/master/financial/orders", icon: CreditCard },
      { title: "Planos", url: "/master/plans", icon: Crown },
      { title: "Pacotes de Crédito", url: "/master/credits-packages", icon: Package },
  ...
  },
  {
    label: "Sistema",
    items: [
      { title: "Cérebro Universal", url: "/master/brain", icon: Brain },
      { title: "Provedores IA", url: "/master/ai-providers", icon: Cpu },
      { title: "Conexões", url: "/master/connections", icon: Plug },
      { title: "API Keys", url: "/master/api-keys", icon: KeyRound },
      { title: "Webhooks", url: "/master/webhooks", icon: Webhook },
      { title: "White Label", url: "/master/white-label", icon: Palette },
      { title: "Config. Global", url: "/master/settings", icon: Settings2 },
    ],
  },
];
