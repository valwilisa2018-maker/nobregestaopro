  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
        ...
        <Button variant="ghost" size="icon" className="relative hover:bg-primary/10">
          <Bell
            className={cn(
              ...
              unread > 0 && "animate-[wiggle_1s_ease-in-out_infinite]",
            )}
          />
          <AnimatePresence>
            {unread > 0 && (
      ...
      <PopoverContent
        align="end"
        sideOffset={8}
        className="w-[92vw] max-w-sm p-0 overflow-hidden border-border/60 bg-gradient-to-b from-background to-background/80 backdrop-blur-xl shadow-2xl"
      >
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            {unread > 0 && (
              <Button
                ...
                variant="outline"
                onClick={markAll}
                className="h-8 gap-1.5 rounded-full border-primary/30 bg-primary/5 text-xs hover:bg-primary/15"
              >
